<html>
    ...
    <body>
        ...
        <div id="gal">
            <img class="imagem" src="Imagens/quibe.jpg" alt="Quibe" title="Quibe" />
            <img class="imagem" src="Imagens/coxinha.jpg" alt="Coxinha" title="Coxinha" />
            <img class="imagem" src="Imagens/bolinha_queijo.jpg" alt="Bolinha de Queijo" title="Bolinha de Queijo" />
            <img class="imagem" src="Imagens/empadinha.jpg" alt="Empadinha" title="Empadinha" />
            <img class="imagem" src="Imagens/mini_churros.jpg" alt="Mini Churros" title="Mini Churros" />
            <img class="imagem" src="Imagens/mini_pastel.jpg" alt="Mini Pastel" title="Mini Pastel" />
        </div>
